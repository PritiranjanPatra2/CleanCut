  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        {/*Image con */}
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">{/*Left side */}
          <div>
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden">
              ...
              {/* <div className="absolute right-1/2 transform translate-x-1/2 translate-y-1/2">
                <div className="border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin sm:mt-15 ">
