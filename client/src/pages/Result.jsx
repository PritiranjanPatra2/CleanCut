      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden">
              ...
              {!resultImage && image && (
                <div className="absolute right-1/2 transform translate-x-1/2 translate-y-1/2">
                  <div className="border-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin sm:mt-15 "></div>
                </div>
              )}
            </div>
          </div>
        ...
        {resultImage && (
          <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
            <button className="px-8 py-2.5 text-violet-600 text-sm  border border-violet-600 rounded-full hover:scale-105 transition-all duration-700 cursor-pointer" onClick={()=>navigate('/')}>
              Try another image
            </button>
